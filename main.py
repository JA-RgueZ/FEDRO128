{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyPiZMogFOwEZ53/za+NsRzN",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/JA-RgueZ/FEDRO128/blob/main/main_py.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        ...
        "\n",
        "        # Retorna el Perfil/Oficio para determinar comandos autorizados\n",
        "        return {\n",
        "            \"identificado\": True,\n",
        "            \"rut\": row[0],\n",
