...
VERSION = "1.03.016" # Versión actualizada para asegurar un cambio detectable
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input[type="text"] {
            ...
            padding: 12px 16px; font-size: 13px; color: var(--text); outline: none;
        ...
        button {
            background: var(--accent); color: #000; border: none; border-radius: 10px; padding: 12px 20px;
            font-family: var(--sans); font-size: 13px; font-weight: 700; cursor: pointer;
            transition: opacity 0.15s, transform 0.1s; white-space: nowrap; display: flex; align-items: center; gap: 7px;
        }
...
<div class="wrapper">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="telefonoPerfil">Tel&eacute;fono</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="telefonoRut">Tel&eacute;fono</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutClientall">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutMembresia">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutDeudaArrastre">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutCuotaAnual">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutPagadoFecha">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutDeuda">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutMensaje">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <label for="rutFinancialAll">RUT sin DV</label>
            <div class="input-row">
    ...
    <div class="card">
        <div class="card-header">
            <span class="method-badge">GET</span>
            <span class="endpoint-path">/library/list_files?recursive=true</span>
        </div>
        <div class="card-body">
            <div class="options-row">
                <input type="checkbox" id="recursiveListFiles">
                <label for="recursiveListFiles" style="margin-bottom:0;">Recursivo</label>
            </div>
            <button onclick="listFiles(this)"><span>&#8594;</span> Listar Archivos</button>
    ...
    <div class="card">
        <div class="card-header">
            <span class="method-badge">GET</span>
            <span class="endpoint-path">/library/search_files/{search_key}?recursive=true</span>
        </div>
        <div class="card-body">
            <label for="searchKeyFiles">Palabra clave</label>
            <div class="options-row">
                <input type="checkbox" id="recursiveSearchFiles">
                <label for="recursiveSearchFiles" style="margin-bottom:0;">Recursivo</label>
            </div>
            <div class="input-row">
...
<script>
    ...
    async function callApi(url, boxId, preId, statusId, btn, label) {
    ...
    function getPerfil(btn) {
        const v = requiredValue("telefonoPerfil");
        if (v === null) return;
        callApi("/auth/perfil/" + encodeURIComponent(v), "boxPerfil", "resultPerfil", "statusPerfil", btn, "Obtener Perfil");
    }

    function getRut(btn) {
        const v = requiredValue("telefonoRut");
        if (v === null) return;
        callApi("/auth/rut/" + encodeURIComponent(v), "boxRut", "resultRut", "statusRut", btn, "Obtener RUT");
    }

    function getClientall(btn) {
        const v = requiredValue("rutClientall");
        if (v === null) return;
        callApi("/auth/clientall/" + encodeURIComponent(v), "boxClientall", "resultClientall", "statusClientall", btn, "Obtener Cliente");
    }

    function getMembresiaAnual(btn) {
        const v = requiredValue("rutMembresia");
        if (v === null) return;
        callApi("/financial/membresia_anual/" + encodeURIComponent(v), "boxMembresia", "resultMembresia", "statusMembresia", btn, "Membresía Anual");
    }

    function getDeudaArrastre(btn) {
        const v = requiredValue("rutDeudaArrastre");
        if (v === null) return;
        callApi("/financial/deuda_arrastre/" + encodeURIComponent(v), "boxDeudaArrastre", "resultDeudaArrastre", "statusDeudaArrastre", btn, "Deuda de Arrastre");
    }

    function getCuotaAnual(btn) {
        const v = requiredValue("rutCuotaAnual");
        if (v === null) return;
        callApi("/financial/cuota_anual/" + encodeURIComponent(v), "boxCuotaAnual", "resultCuotaAnual", "statusCuotaAnual", btn, "Cuota Anual");
    }

    function getPagadoALaFecha(btn) {
        const v = requiredValue("rutPagadoFecha");
        if (v === null) return;
        callApi("/financial/pagado_a_la_fecha/" + encodeURIComponent(v), "boxPagadoFecha", "resultPagadoFecha", "statusPagadoFecha", btn, "Pagado a la Fecha");
    }

    function getDeuda(btn) {
        const v = requiredValue("rutDeuda");
        if (v === null) return;
        callApi("/financial/deuda/" + encodeURIComponent(v), "boxDeuda", "resultDeuda", "statusDeuda", btn, "Obtener Deuda");
    }

    function getMensaje(btn) {
        const v = requiredValue("rutMensaje");
        if (v === null) return;
        callApi("/financial/mensaje/" + encodeURIComponent(v), "boxMensaje", "resultMensaje", "statusMensaje", btn, "Obtener Mensaje");
    }

    function getFinancialAll(btn) {
        const v = requiredValue("rutFinancialAll");
        if (v === null) return;
        callApi("/financial/all/" + encodeURIComponent(v), "boxFinancialAll", "resultFinancialAll", "statusFinancialAll", btn, "Obtener Todo Financiero");
    }

    function listFiles(btn) {
        const recursive = document.getElementById("recursiveListFiles").checked;
        const url = "/library/list_files" + (recursive ? "?recursive=true" : "");
        callApi(url, "boxListFiles", "resultListFiles", "statusListFiles", btn, "Listar Archivos");
    }

    function getFileId(btn) {
        const v = requiredValue("fileNameGetId");
        if (v === null) return;
        callApi("/library/get_file_id/" + encodeURIComponent(v), "boxGetFileId", "resultGetFileId", "statusGetFileId", btn, "Obtener ID del Archivo");
    }

    function searchFiles(btn) {
        const v = requiredValue("searchKeyFiles");
        if (v === null) return;
        const recursive = document.getElementById("recursiveSearchFiles").checked;
        const url = "/library/search_files/" + encodeURIComponent(v) + (recursive ? "?recursive=true" : "");
        callApi(url, "boxSearchFiles", "resultSearchFiles", "statusSearchFiles", btn, "Buscar Archivos");
    }
</script>
</body>
</html>
